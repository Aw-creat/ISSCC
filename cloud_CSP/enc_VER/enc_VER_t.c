...
static sgx_status_t SGX_CDECL sgx_foo_th(void* pms)
{
	CHECK_REF_POINTER(pms, sizeof(ms_foo_th_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_foo_th_t* ms = SGX_CAST(ms_foo_th_t*, pms);
	ms_foo_th_t __in_ms;
	if (memcpy_s(&__in_ms, sizeof(ms_foo_th_t), ms, sizeof(ms_foo_th_t))) {
